...
{{- define "indexer.minReplicasSpot" -}}
{{- $tier := include "indexer.getTier" . -}}
...
{{- define "indexer.maxReplicasSpot" -}}
{{- $tier := include "indexer.getTier" . -}}
...
{{- define "indexer.replicasStandard" -}}
{{- $tier := include "indexer.getTier" . -}}
