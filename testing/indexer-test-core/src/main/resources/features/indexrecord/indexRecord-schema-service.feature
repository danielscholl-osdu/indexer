Feature: Indexing of the documents
  ...
  Scenario Outline: Ingest record and check for properly parsed array of Strings
    ...
    Examples:
      | kind                                                            | recordFile                                   | index                                                          | acl                            | field                                                                  | id                                                                                   | number | value |
      | "osdu:wks:reference-data--IndexPropertyPathConfiguration:1.0.0" | "osdu_wks_IndexPropertyPathConfiguration_v1" |"osdu-wks-reference-data--indexpropertypathconfiguration-1.0.0" | "data.default.viewers@tenant1" | "data.Configurations.Paths.ValueExtraction.RelatedConditionMatches" | "osdu:reference-data--IndexPropertyPathConfiguration:index-property--Wellbore:1."    | 2 | "^[\w\-\.]+:reference-data\-\-AliasNameType:UniqueIdentifier:$,^[\w\-\.]+:reference-data\-\-AliasNameType:RegulatoryName:$,^[\w\-\.]+:reference-data\-\-AliasNameType:PreferredName:$,^[\w\-\.]+:reference-data\-\-AliasNameType:CommonName:$,^[\w\-\.]+:reference-data\-\-AliasNameType:ShortName:$" |
      | "osdu:wks:reference-data--IndexPropertyPathConfiguration:1.0.0" | "well_augmenter_configuration"               |"osdu-wks-reference-data--indexpropertypathconfiguration-1.0.0" | "data.default.viewers@tenant1" | "data.Configurations.Paths.RelatedObjectsSpec.RelatedConditionMatches" | "osdu:reference-data--IndexPropertyPathConfiguration:index-property--Well:1." | 1 | "opendes:reference-data--GeoPoliticalEntityType:Country:" |
