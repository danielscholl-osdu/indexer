Feature: Indexing of the documents
  ...
  Scenario Outline: Ingest the record and Index in the Elastic with AsIngestedCoordinates properties
    ...
    Examples:
      ...
      | "tenant1:wks:master-data--Wellbore:2.0.4"              | "r3-index_record_wks_master"      | 1      | "tenant1-wks-master-data--wellbore-2.0.4"              | "data.default.viewers@tenant1" | "data.ProjectedBottomHoleLocation.AsIngestedCoordinates.CoordinateReferenceSystemID"  | "osdu:reference-data--CoordinateReferenceSystem:ED_1950_UTM_Zone_31N:"    | "ProjectedBottomHoleLocation.AsIngestedCoordinates.persistableReferenceCrs"  |
      | "tenant1:wks:master-data--Wellbore:2.0.4"              | "r3-index_record_wks_master"      | 1      | "tenant1-wks-master-data--wellbore-2.0.4"              | "data.default.viewers@tenant1" | "data.SpatialLocation.AsIngestedCoordinates.CoordinateReferenceSystemID"              | "osdu:reference-data--CoordinateReferenceSystem:ED_1950_UTM_Zone_31N:"    | "SpatialLocation.AsIngestedCoordinates.persistableReferenceCrs"              |
      | "tenant1:indexer:virtual-properties-Integration:1.0.1" | "index_record_virtual_properties" | 1      | "tenant1-indexer-virtual-properties-integration-1.0.1" | "data.default.viewers@tenant1" | "data.ProjectedBottomHoleLocation.AsIngestedCoordinates.CoordinateReferenceSystemID"  | "osdu:reference-data--CoordinateReferenceSystem:WGS_1984_World_Mercator:" | "ProjectedBottomHoleLocation.AsIngestedCoordinates.persistableReferenceCrs"  |
      | "tenant1:indexer:virtual-properties-Integration:1.0.1" | "index_record_virtual_properties" | 2      | "tenant1-indexer-virtual-properties-integration-1.0.1" | "data.default.viewers@tenant1" | "data.GeographicBottomHoleLocation.AsIngestedCoordinates.CoordinateReferenceSystemID" | "osdu:reference-data--CoordinateReferenceSystem:WGS_1984_World_Mercator:" | "GeographicBottomHoleLocation.AsIngestedCoordinates.persistableReferenceCrs" |
      | "tenant1:indexer:virtual-properties-Integration:1.0.1" | "index_record_virtual_properties" | 3      | "tenant1-indexer-virtual-properties-integration-1.0.1" | "data.default.viewers@tenant1" | "data.SpatialLocation.AsIngestedCoordinates.CoordinateReferenceSystemID"              | "osdu:reference-data--CoordinateReferenceSystem:WGS_1984_World_Mercator:" | "SpatialLocation.AsIngestedCoordinates.persistableReferenceCrs"              |
  ...
  Scenario Outline: Ingest the record and Index in the Elastic with AsIngestedCoordinates properties and search by coordinates
    ...
    Examples:
      ...
      | "tenant1:wks:master-data--Wellbore:2.0.4"              | "r3-index_record_wks_master"      | 1      | "tenant1-wks-master-data--wellbore-2.0.4"              | "data.default.viewers@tenant1" | "data.ProjectedBottomHoleLocation.AsIngestedCoordinates.FirstPoint.X" | 710000    | 700000       | "data.ProjectedBottomHoleLocation.AsIngestedCoordinates.FirstPoint.Y" | 5800000   | 5700000      |
      | "tenant1:indexer:virtual-properties-Integration:1.0.1" | "index_record_virtual_properties" | 1      | "tenant1-indexer-virtual-properties-integration-1.0.1" | "data.default.viewers@tenant1" | "data.ProjectedBottomHoleLocation.AsIngestedCoordinates.FirstPoint.X" | 2600000   | 2500000      | "data.ProjectedBottomHoleLocation.AsIngestedCoordinates.FirstPoint.Y" | -3500000  | -3600000     |
      | "tenant1:indexer:decimation-Integration:1.0.1"         | "index_record_seismic_survey"     | 1      | "tenant1-indexer-decimation-integration-1.0.1"         | "data.default.viewers@tenant1" | "data.SpatialLocation.AsIngestedCoordinates.FirstPoint.X"             | 1151940   | 1151930      | "data.SpatialLocation.AsIngestedCoordinates.FirstPoint.Y"             | 4843810   | 4843800      |
