Feature: Indexing of the documents
  ...
  Background:
    Given the schema is created with the following kind
      ...
      | tenant1:indexer:test-update-data--Integration:1.0.1 | tenant1-indexer-test-update-data--integration-1.0.1 | index_update_records_schema_v1  |
      | tenant1:indexer:test-update-data--Integration:2.0.1 | tenant1-indexer-test-update-data--integration-2.0.1 | index_update_records_schema_v2  |
  ...
  Scenario Outline: Ingest the record and Index in the Elastic Search
    ...
    Examples:
      ...
      | "tenant1:indexer:test-update-data--Integration:1.0.1" | "tenant1-indexer-test-update-data--integration-1.0.1" | "index_update_records_schema_v1" | "data.default.viewers@tenant1"        | "tenant1:indexer:test-update-data--Integration:2.0.1" | "tenant1-indexer-test-update-data--integration-2.0.1" |