Feature: Indexing of the documents
  ...
  Background:
    Given the schema is created with the following kind
      ...
      | tenant1:indexer:test-data--Integration:4.0.0        | tenant1-indexer-test-data--integration-4.0.0        | index_records_4                |
  ...
  Scenario Outline: Ingest the record and Index in the Elastic Search
    ...
    Examples:
      ...
      | "tenant1:indexer:test-data--Integration:4.0.0" | "index_records_schema_4" | 2      | "tenant1-indexer-test-data--integration-4.0.0" | "data.default.viewers@tenant1" | {"mappings":{"well":{"dynamic":"false","properties":{"acl":{"properties":{"owners":{"type":"keyword"},"viewers":{"type":"keyword"}}},"ancestry":{"properties":{"parents":{"type":"keyword"}}},"data":{"properties":{"Field":{"type":"text","fields":{"keyword":{"type":"keyword","ignore_above":256}}},"Location":{"type":"geo_point"},"Basin":{"type":"text","fields":{"keyword":{"type":"keyword","ignore_above":256}}},"Score":{"type":"integer"}}}}}} |
  @default
  ...
  Scenario Outline: Ingest the record and Index in the Elastic with AsIngestedCoordinates properties and search by coordinates
    ...
    Examples:
      ...
      | "tenant1:indexer:virtual-properties-Integration:1.0.0" | "index_record_virtual_properties" | 1      | "tenant1-indexer-virtual-properties-integration-1.0.0" | "data.default.viewers@tenant1" | "data.ProjectedBottomHoleLocation.AsIngestedCoordinates.FirstPoint.X" | 2504888.139 | 2504888.138 | "data.ProjectedBottomHoleLocation.AsIngestedCoordinates.FirstPoint.Y" | -3525752.639 | -3525752.640 |
