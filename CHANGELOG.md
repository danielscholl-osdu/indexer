...
* **devops:** Add OTEL exporter protocol configuration ([d9c0457](https://github.com/danielscholl-osdu/indexer/commit/d9c0457a94215bde98e9e71f2f0e860d79b3ed8b))
* Sync upstream changes from ([cce0634](https://github.com/danielscholl-osdu/indexer/commit/cce063441256ac0a86a4601cf2169ada74e0eab9))


### 🐛 Bug Fixes

* Aws build command ([48de2b9](https://github.com/danielscholl-osdu/indexer/commit/48de2b9ead9bd0f80a0bdd1d76a98400ec7672c5))
* Cve and spring boot version bump ([0e5edca](https://github.com/danielscholl-osdu/indexer/commit/0e5edcaec48feec5c47485eceb5baa5f02ddabdd))
* Cve and spring boot version bump ([ee20e10](https://github.com/danielscholl-osdu/indexer/commit/ee20e102ac9464d67ef97f670436f11c1cfa4543))
...
* Tomcat-core CVE ([682533a](https://github.com/danielscholl-osdu/indexer/commit/682533a1c4825645ddc4a9fcfed893b66ae134e3))
* Tomcat-core CVE ([1dfd49b](https://github.com/danielscholl-osdu/indexer/commit/1dfd49bd33d003024450cedbbc133e4a0ed8d2b6))
...
* Complete repository initialization ([7fcdaa1](https://github.com/danielscholl-osdu/indexer/commit/7fcdaa105003fcf0baf6ad063f7a0eeddbebc906))
* Copy configuration and workflows from main branch ([2e7b876](https://github.com/danielscholl-osdu/indexer/commit/2e7b8763ba4678cc0b37d56746e5b37ce4ab5528))
* Defaulting collaboration ff to true to avoid compatibility issues ([e4703dc](https://github.com/danielscholl-osdu/indexer/commit/e4703dc24c4d00eb31b4b45f8581b17c10b02c1b))
* Defaulting collaboration ff to true to avoid compatibility issues ([9ce4828](https://github.com/danielscholl-osdu/indexer/commit/9ce48282321561fdd30a5a462e79e5cb21796d4b))
...
* Fixing sonar issues ([3f6e169](https://github.com/danielscholl-osdu/indexer/commit/3f6e16981bd7dc94135709848444c4ad0ea044ff))
* Fixing sonar issues ([03202b2](https://github.com/danielscholl-osdu/indexer/commit/03202b21540d7289d0e781ee234b42b07a4e65d6))
...
* Sync template updates ([f6787b5](https://github.com/danielscholl-osdu/indexer/commit/f6787b5104cc720f9414f6d904a846586023054b))
