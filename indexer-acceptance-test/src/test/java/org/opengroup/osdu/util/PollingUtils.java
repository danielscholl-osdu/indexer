...
public class PollingUtils {
    ...
    public static PollingResult<Void> retryOperation(
        ...
        PollingResult<Boolean> innerResult = pollWithRetry(
            config,
            () -> {
        ...
        return innerResult.isSuccess()
            ? PollingResult.success(null, innerResult.getAttempts(), innerResult.getTotalWaitTimeMs())
            : PollingResult.failure(innerResult.getFailureReason(), innerResult.getAttempts(), innerResult.getTotalWaitTimeMs());
    }
